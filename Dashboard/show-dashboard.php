    ...
    <section role="main" class="content-body">
        ...
        if (strpos($loggedUserName, 'dist') !== false) {
            ...
            $TotalDataQry = "SELECT count(id) as TotalHouseHold, 
							...
							FROM xformrecord 
							WHERE UserID $distUserIdSelectCodition 
									AND CompanyID = ?  
									AND FormId = ?";
            ...
            if ($FormID == $formIdSamplingData) {
                $TotalTergetQry = "SELECT SUM(NumberOfRecord) as TotalTerget FROM PSUList where PSUUserID $distUserIdSelectCodition AND CompanyID = ? and PSUUserID <>'' and FarmName=''";
                ...
                $TotalTergetQry = "SELECT SUM(NumberOfRecordForMainSurvey) as TotalTerget FROM PSUList where PSUUserID $distUserIdSelectCodition AND CompanyID = ? and PSUUserID <>'' and FarmName=''";
                $TotalTergetQry .= $qryCreate2;
            ...
            $TopSenderQuery = "SELECT top 7 xfr.UserID, ui.UserName, COUNT(*) AS Number FROM xformrecord xfr JOIN userinfo ui ON xfr.UserID = ui.id WHERE xfr.UserID $distUserIdSelectCodition AND  xfr.CompanyId = ?  AND xfr.FormId = ? AND ui.id NOT IN(68, 69)";
            ...
            $LastSenderQuery = "SELECT top 7 xfr.UserID, ui.UserName, COUNT(*) AS Number FROM xformrecord xfr JOIN userinfo ui ON xfr.UserID = ui.id WHERE xfr.UserID $distUserIdSelectCodition AND  xfr.CompanyId = ?  AND xfr.FormId = ? AND ui.id NOT IN(68, 69)";
            ...
            if ($FormID == $formIdSamplingData) {
                $TotalTergetQry = "SELECT SUM(NumberOfRecord) as TotalTerget FROM PSUList where CompanyID = ? and PSUUserID <>'' and FarmName=''";
                $TotalTergetQry .= $qryCreate2;
                ...
                $TotalTergetQry = "SELECT SUM(NumberOfRecordForMainSurvey) as TotalTerget FROM PSUList where CompanyID = ? and PSUUserID <>'' and FarmName=''";
                $TotalTergetQry .= $qryCreate2;
            ...
            $TopSenderQuery = "SELECT top 7 xfr.UserID, ui.UserName, COUNT(*) AS Number FROM xformrecord xfr JOIN userinfo ui ON xfr.UserID = ui.id WHERE xfr.CompanyId = ?  AND xfr.FormId = ? AND ui.id NOT IN(68, 69)";
            $TopSenderQuery .= $qryCreate;
            $TopSenderQuery .= " GROUP BY xfr.UserID,ui.UserName";
            //$TopSenderQuery .= " HAVING COUNT(*)<49";
            $TopSenderQuery .= " ORDER BY Number DESC";
